          ...
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="asset_name" name="asset_name" placeholder="Enter asset name" value="<?php echo $product_data['name']; ?>"  autocomplete="off"/>
                </div>

                <div class="form-group">
                  <label for="asset_code">Asset code</label>
                  <input type="text" class="form-control" id="asset_code" name="asset_code" placeholder="Enter asset code" value="<?php echo $product_data['code']; ?>" autocomplete="off" />
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="date_buy" name="date_buy" placeholder="Enter date" value="<?php echo $product_data['dateBuy']; ?>" autocomplete="off" />
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="condition" name="condition">
                    <option value="1" <?php if($product_data['condition'] == 1) { echo "selected='selected'"; } ?>>Layak</option>
                    <option value="2" <?php if($product_data['condition'] != 1) { echo "selected='selected'"; } ?>>Rusak</option>
                  </select>
                </div>
