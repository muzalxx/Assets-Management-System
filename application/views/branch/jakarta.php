    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('deleteProduct', $user_permission)): ?>
          <a id="generateQR" class="btn btn-primary"><i class="bi bi-qr-code"></i> Select item for Generate</a>
        <?php endif; ?>
        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="btn-group" role="group" aria-label="">
              <input type="radio" class="btn-check" name=" " id="btnAll" value=" " autocomplete="off" checked>
              <label class="btn btn-primary" for="btnAll">All</label>
              
              <input type="radio" class="btn-check" name="Electronic" id="btnElectronic" value="Electronic" autocomplete="off">
              <label class="btn btn-primary" for="btnElectronic"><i class="bi bi-laptop"></i></label>

              <input type="radio" class="btn-check" name="Furniture" id="btnFurniture" value="Furniture" autocomplete="off">
              <label class="btn btn-primary" for="btnFurniture"><i class="bi bi-boxes"></i></label>

              <input type="radio" class="btn-check" name="Vehicle" id="btnVehicle" value="Vehicle" autocomplete="off">
              <label class="btn btn-primary" for="btnVehicle"><i class="bi bi-car-front"></i></label>
              
              <input type="radio" class="btn-check" name="Others" id="btnOthers" value="Others" autocomplete="off">
              <label class="btn btn-primary" for="btnOthers"><i class="bi bi-question-circle"></i> </label>
            </div> 
          </div>
          <!-- /.box-header -->
...
$(document).ready(function() {
  ...
  $("#jakartaBranchNav").addClass('active');

  // initialize the datatable core
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'branch/fetchProductJakarta',
    'order': [],
    'sort': false,
    'searching': true,
    'select': {
  ...
  $('#generateQR').on('click', function(){
    $(this).html('<i class="bi bi-qr-code"></i> Generate QR');
    
    $('#manageTable tbody').on('click', 'tr', function(){
      $(this).toggleClass('selected');
      $('#generateQR').attr("href", base_url +'products/generateQR');
      $('#generateQR').attr("target", "_blank");
    });
  });
...
//   $("#viewTable").DataTable({
//       'ajax' : {
//         'url': base_url + 'branch/viewProductJakarta',
//         'type' : 'POST',
//         'data': { product_id:id },
//       },
//       'order' : [],
